...
public:
    Pasajero(int id, string nombre, string fechaNacimiento, char genero, string direccion, int telefono, string correo, string nacionalidad, int noMaletas, string infoMedica);
    Pasajero();
    string Get_Tipo();
